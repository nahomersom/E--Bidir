...
class MyLoansDataGrid extends StatelessWidget {
  ...
  EmployeeDataSource employeeDataSource = EmployeeDataSource(myLoanData: []);
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: BlocProvider<MyLoanBloc>(
          create: (BuildContext context) =>
              MyLoanBloc(myLoanRepo: BankRepo(apiClient: ApiClient()))
                ..add(GetMyLoans()),
          child: Scaffold(
              appBar: AppBar(
                actions: <Widget>[
              ...
              body: BlocConsumer<MyLoanBloc, MyLoanState>(
                ...
                builder: (BuildContext context, state) {
                  state.status.isSuccess
                      ? employeeDataSource =
                          EmployeeDataSource(myLoanData: state.myLoanInfo)
                      : null;
  ...
  EmployeeDataSource({required List<MyLoanInfo> myLoanData}) {
    _employeeData = myLoanData
        .map<DataGridRow>((e) => DataGridRow(cells: [
              ...
              DataGridCell<String>(
                  columnName: 'Interest', value: e.interest.toString()),
              DataGridCell<String>(
                  columnName: 'Type_Of_Loan', value: e.Type_Of_Loan),
              DataGridCell<String>(
                  columnName: 'Job_Status', value: e.Job_Status),
              DataGridCell<String>(
                ...
                return IconButton(
                    onPressed: () => {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      LoanDetail(loanDetail: row.getCells()))),
                        },
                    icon: FaIcon(
