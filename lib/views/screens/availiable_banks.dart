...
class AvailableBanksDataGrid extends StatefulWidget {
  /// Creates the home page.
  AvailableBanksDataGrid({Key? key}) : super(key: key);

  @override
  _AvailableBanksDataGridState createState() => _AvailableBanksDataGridState();
}

class _AvailableBanksDataGridState extends State<AvailableBanksDataGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text('Available Banks Data'.toString(),style: _textTheme.titleLarge?.copyWith(
